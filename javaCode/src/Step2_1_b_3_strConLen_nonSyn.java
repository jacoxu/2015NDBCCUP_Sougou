...
public class Step2_1_b_3_strConLen_nonSyn {
	/**
	 * @param args
	...
	public static void main(String[] args) {
	    ...
	    String tarFilePath=dataPathStr+"feaSet/Step2_1_b_3_labeledDataFea_nonSyn.txt";	
		
	    //处理未标注数据
//	    String scrData=dataPathStr+"Data/Step2_1_a_7_unlabeledData.txt";
//	    String tarFilePath=dataPathStr+"feaSet/Step2_1_b_3_unlabeledDataFea_nonSyn.txt";	
	    
	    Step2_1_b_3_strConLen_nonSyn fr=new Step2_1_b_3_strConLen_nonSyn();
