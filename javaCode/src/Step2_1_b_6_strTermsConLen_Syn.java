...
public class Step2_1_b_6_strTermsConLen_Syn {
	/**
	 * @param args
	...
	public static void main(String[] args) {
	    ...
	    String tarFilePath=dataPathStr+"feaSet/Step2_1_b_6_labeledDataFea_Syn.txt";	
		
	    //处理未标注数据
//	    String scrData=dataPathStr+"Data/Step2_1_a_8_unlabeledData.txt";
//	    String tarFilePath=dataPathStr+"feaSet/Step2_1_b_6_unlabeledDataFea_Syn.txt";	
	    
	    Step2_1_b_6_strTermsConLen_Syn fr=new Step2_1_b_6_strTermsConLen_Syn();
