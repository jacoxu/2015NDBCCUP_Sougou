...
public class Step2_1_b_1_tStrContainQ_nonSyn {
	/**
	 * @param args
		...
		try {
			...
			if (file.isFile() && file.exists()) {
				...
				while ((lineTXT = bufferedReader.readLine()) != null) {
					...
					//把过滤好的文本写入到新的文本文件中
					Result2Txt(tarFilePath,tmpFeaBuffer.toString());
	...
	public static void main(String[] args) {
	    ...
	    String tarFilePath=dataPathStr+"feaSet/Step2_1_b_1_labeledDataFea_nonSyn.txt";	
		
	    //处理未标注数据
//	    String scrData=dataPathStr+"Data/Step2_1_a_7_unlabeledData.txt";
//	    String tarFilePath=dataPathStr+"feaSet/Step2_1_b_1_unlabeledDataFea_nonSyn.txt";	
	    
	    Step2_1_b_1_tStrContainQ_nonSyn fr=new Step2_1_b_1_tStrContainQ_nonSyn();
