...
public class Step2_1_b_6_strTermsConLen_nonSyn {
	/**
	 * @param args
...
//	    String tarFilePath=dataPathStr+"feaSet/Step2_1_b_6_labeledDataFea_nonSyn.txt";	
		
	    //处理未标注数据
	    String scrData=dataPathStr+"Data/Step2_1_a_7_unlabeledData.txt";
	    String tarFilePath=dataPathStr+"feaSet/Step2_1_b_6_unlabeledDataFea_nonSyn.txt";	
	    
	    Step2_1_b_6_strTermsConLen_nonSyn fr=new Step2_1_b_6_strTermsConLen_nonSyn();
