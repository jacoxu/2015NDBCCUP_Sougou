...
public class Step2_1_b_7_genSVM_nonSyn {
...
//		String[] tokensStr  = tempLine.split("\t");
		...
		String dataPathStr="./../";
		String wordMapStr = dataPathStr+"/feaSet/Step2_1_b_7_wordDictWithIdx_nonSyn.dic";
		String vsmBW_TrainQueryStr = dataPathStr+"/feaSet/Step2_1_b_7_vsmBW_TrainQuery_nonSyn.txt";
		String vsmBW_TrainTitleStr = dataPathStr+"/feaSet/Step2_1_b_7_vsmBW_TrainTitle_nonSyn.txt";
		String vsmBW_TestQueryStr = dataPathStr+"/feaSet/Step2_1_b_7_vsmBW_TestQuery_nonSyn.txt";
		String vsmBW_TestTitleStr = dataPathStr+"/feaSet/Step2_1_b_7_vsmBW_TestTitle_nonSyn.txt";
